...
def index():
    ...
    return render_template('introduction_v3.html', hour=now.hour)
...
def hobby():
    ...
    hobbies = ['Chess', 'Scrabble', 'Walk']
    return render_template('hobbies_v3.html', hobbies=hobbies)
...
def food():
    ...
    return render_template('food_v3.html', foods=foods)
...
def skills():
    ...
    return render_template("skills_v3.html", skills=skill_levels)
