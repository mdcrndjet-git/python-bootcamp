...
def save(expenses, filepath):
    """Save the current list of expenses line-by-line"""
    with open(filepath, "w") as file:
        for expense in expenses:
            file.write(f"{expense}\n")


def load(expenses, filepath):
    """Load the current list of expenses line-by-line"""
...
def main():
    ...
    while command:
        if command == "add":
            ...
            save(current_expenses, input("Filepath:\t"))
        elif command == "load":
            load(current_expenses, input("Filepath:\t"))
